...
// Replaces the former Settings drawer: a dedicated Configuration page,
// reachable from the same header icon, distinct from the Home/Downloads/
// Playlist/Logs tabs. See frontend-configuration-page and
// frontend-app-settings-management.
export function ConfigurationPage({
  ...
  return (
    <div className="configuration-page">
      ...
      {/* Sources M3U */}
      <DisclosureSection
        title={t('sections.m3uSources')}
        isExpanded={isSourcesExpanded}
        onToggle={() => setIsSourcesExpanded(open => !open)}
      >
        <M3uSourcesSection
          isExpanded={isSourcesExpanded}
          sources={sources}
      ...
      <DisclosureSection
        ...
        onToggle={() => setIsIntegrationsExpanded(open => !open)}
      >
        <IntegrationsSection
          isExpanded={isIntegrationsExpanded}
          settings={settings}
      ...
      <DisclosureSection
        ...
        onToggle={() => setIsNotificationsExpanded(open => !open)}
      >
      ...
      <DisclosureSection
        ...
        onToggle={() => setIsAdvancedExpanded(open => !open)}
      >
        <AdvancedSection
          isExpanded={isAdvancedExpanded}
          settings={settings}
