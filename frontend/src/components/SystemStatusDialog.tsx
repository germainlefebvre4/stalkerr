...
export function SystemStatusDialog({ isOpen, onOpenChange }: SystemStatusDialogProps) {
  ...
  return (
    <Dialog.Root open={isOpen} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="dialog-content" style={{ maxHeight: '85vh', overflowY: 'auto' }}>
